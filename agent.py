...
class Agent:
    def __innit__(self):
        ...
        self.train = QTrainer(self.model, lr=LR, gamma=self.gamma) #gamma is the discoutn rate, which needs to be less than 1
        # to do: model, trainer.
    ...
    def get_action(self, state):
        ...
        self.epsilon = 80 - self.n_games # hardcoded so we can wiggle it
        final_move = [0, 0, 0]
